...
mainRouter.get('/medicines', protect, authorize('admin', 'pharmacy', 'doctor'), medicineController.list);
mainRouter.post('/medicines', protect, authorize('admin', 'pharmacy'), medicineController.create);
mainRouter.get('/medicines/search', protect, authorize('admin', 'pharmacy', 'doctor'), medicineController.search);
mainRouter.get('/medicines/:id', protect, authorize('admin', 'pharmacy', 'doctor'), medicineController.get);
...
medicineRouter.get('/batches', protect, authorize('admin', 'pharmacy', 'doctor'), batchController.listForMedicine);
