...
router.get('/check-duplicate', authorize('admin', 'receptionist'), patientController.checkDuplicate);
...
router.patch('/:id', authorize('admin', 'receptionist'), patientController.update);
router.delete('/:id', authorize('admin', 'receptionist'), patientController.remove);
