...
mainRouter.get('/investigations/:id', protect, authorize('admin', 'doctor', 'receptionist'), investigationController.get);
...
consultationRouter.get('/', protect, authorize('admin', 'doctor', 'receptionist'), investigationController.listByConsultation);

// GET /api/patients/:patientId/investigations
const patientRouter = express.Router({ mergeParams: true });
patientRouter.get('/', protect, authorize('admin', 'doctor', 'receptionist'), investigationController.listByPatient);
